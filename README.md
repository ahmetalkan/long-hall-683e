...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/long-hall-683e
```

A live public deployment of this template is available at [https://long-hall-683e.templates.workers.dev](https://long-hall-683e.templates.workers.dev)
